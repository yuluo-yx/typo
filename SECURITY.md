...
- The install script currently downloads release binaries from GitHub over HTTPS, or downloads the `main` branch source and builds locally; it does not currently verify checksums or signatures
